...
import { Form, Tooltip, Input, Col, Row, Checkbox, Switch, Button, InputNumber, DatePicker, Radio, Select } from 'antd';
...
function FormBuilderField(props) {
  var field = props.field,
      meta = props.meta,
      form = props.form;
  var label = field.tooltip ? /*#__PURE__*/React.createElement("span", null, field.label, /*#__PURE__*/React.createElement(Tooltip, {
    title: field.tooltip
  }, ' ', /*#__PURE__*/React.createElement(QuestionIcon, null))) : field.label;
  ...
  if (isFieldViewMode) {
    ...
    if (field.renderView) {
      ...
      viewEle = /*#__PURE__*/React.createElement(ViewWidget, _extends({
        value: viewValue,
        form: form,
        field: field
      ...
      viewEle = /*#__PURE__*/React.createElement("a", {
        href: href,
    ...
    if (!viewEle) {
      if (typeof viewValue === 'boolean') viewEle = capitalize(String(viewValue));else if (viewValue === undefined) viewEle = 'N/A';else {
        viewEle = /*#__PURE__*/React.createElement("span", {
    ...
    if (form && field.readOnly) {
      var _ele = /*#__PURE__*/React.createElement("span", {
        className: "antd-form-builder-read-only-content"
      }, viewEle);

      return /*#__PURE__*/React.createElement(FormItem, formItemProps, isV4 ? _ele : form.getFieldDecorator(field.id || field.key, fieldProps)(_ele));
    }

    delete formItemProps.name;
    delete formItemProps.key;
    return /*#__PURE__*/React.createElement(FormItem, formItemProps, viewEle);
  } // Handle widget props


  var wp = field.widgetProps || {};

  var widgetProps = _objectSpread2(_objectSpread2({}, pick(field, ['placeholder', 'type', 'className', 'class', 'onChange'])), {}, {
    disabled: field.disabled || meta.disabled || props.disabled
  }, wp);

  var FieldWidget = field.widget || Input;
  ...
  var valueProps = {};
  var ele = /*#__PURE__*/React.createElement(FieldWidget, _extends({}, widgetProps, valueProps), field.children || null);
  var ele2 = isV4 ? ele : form.getFieldDecorator(field.id || field.key, fieldProps)(ele);

  if (isV4) {
    // antd v4 always has form item
    return /*#__PURE__*/React.createElement(FormItem, formItemProps, ele);
  }

  return field.noFormItem || field.noStyle ? ele2 : /*#__PURE__*/React.createElement(FormItem, formItemProps, ele2);
}
...
function FormBuilder(props) {
  ...
  return /*#__PURE__*/React.createElement(FormBuilderInner, _extends({}, props, {
...
function FormBuilderInner(props) {
  ...
  var elements = fields.map(function (field) {
    return /*#__PURE__*/React.createElement(FormBuilderField, {
      key: field.key,
      field: field,
      disabled: disabled,
      meta: newMeta,
...
FormBuilder.defineWidget('checkbox', Checkbox, function (field) {
  return _objectSpread2(_objectSpread2({}, field), {}, {
    valuePropName: 'checked'
  });
});
FormBuilder.defineWidget('switch', Switch, function (field) {
  return _objectSpread2(_objectSpread2({}, field), {}, {
    valuePropName: 'checked'
  });
});
...
FormBuilder.defineWidget('radio-group', Radio.Group, function (field) {
  var RadioComp = field.buttonGroup ? Radio.Button : Radio;
  ...
  if (field.options && !field.children) {
    return _objectSpread2(_objectSpread2({}, field), {}, {
      ...
      children: mapOptions(field.options).map(function (opt) {
        return /*#__PURE__*/React.createElement(RadioComp, {
          value: opt.value,
          key: opt.value
        }, opt.label);
      })
...
FormBuilder.defineWidget('checkbox-group', Checkbox.Group, function (field) {
  if (field.options && !field.children) {
    return _objectSpread2(_objectSpread2({}, field), {}, {
      children: mapOptions(field.options).map(function (opt) {
...
FormBuilder.defineWidget('select', Select, function (field) {
  if (field.options && !field.children) {
    return _objectSpread2(_objectSpread2({}, field), {}, {
      children: mapOptions(field.options).map(function (opt) {
